...
vsim top -t 1ps -displaymsgmode both -debugDB -lib work -do "onbreak {resume};  log /* -r; \
    add wave -position end  sim:/top/logic_gate_inst/i_clk; \
    add wave -position end  sim:/top/logic_gate_inst/i_rst_n; \
    add wave -position end  sim:/top/logic_gate_inst/i_DATA; \
    add wave -position end  sim:/top/logic_gate_inst/o_DATA; \
